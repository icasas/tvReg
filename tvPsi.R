...
#' @param unit.shock Logical. If TRUE, the impulse responses are calculated for a one unit shock. 
#' If FALSE (default), they are calculated for a one standard deviation shock.
...
#' @rdname tvPsi
#' @export
tvPsi<- function (x, nstep = 10, ortho.cov = "const", bw.cov = NULL, unit.shock = FALSE, ...)
{
  if (!inherits(x, "tvvar"))
